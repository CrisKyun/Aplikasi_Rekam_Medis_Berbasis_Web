    ...
    <div class="col-md-8">
        ...
        <div class="card shadow-sm">
            <div class="card-header bg-primary text-white fw-bold">
                ...
                Tambah Rekam Medis — {{ $pasien->nama_lengkap }}
            </div>
            <div class="card-body">
                <form action="/rekam-medis/{{ $pasien->id }}/tambah" method="POST">
                    @csrf
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="dokter"
                                ...
                                value="{{ old('dokter') }}" placeholder="Nama dokter pemeriksa">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" name="tekanan_darah"
                                class="form-control" value="{{ old('tekanan_darah') }}"
                                placeholder="120/80">
                        </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="number" name="suhu_tubuh" step="0.1"
                                class="form-control" value="{{ old('suhu_tubuh') }}"
                                placeholder="36.5">
                        </div>
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="diagnosis" rows="3"
                                ...
                                placeholder="Diagnosis dokter...">{{ old('diagnosis') }}</textarea>
